...
export default function NavbarJoinUs({ isOpen, handleClick }) {
  return (
    <div className="text-white font-[Convergence] hover:scale-105 hover:translate-x-1 transition-transform duration-200">
      <button onClick={handleClick} className="flex flex-col items-center">
        ...
        <span className="text-xs w-full text-center">Te&nbsp;hono</span>
      </button>
    </div>
  )
}
