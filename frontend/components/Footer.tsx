...
const Footer = () => {
  return (
    <>
      <footer className="bg-gradient-to-r from-[#8A5082] to-[#A5CAD2] text-whi50 pt-10 px-50 ">
        <div className="grid grid-cols-1 lg:grid-cols-5 grid-rows-1 font-[sansation] text-md">
          <div className="">
        ...
        <div className="grid lg:grid-cols-3 grid-rows-1 gap-1 pb-10 pt-10">
          <div>
            <p className="font-[sansation] text-sm font-bold text-gray-100">
              Privacy Policy
            </p>
            <p className="font-[sansation] text-xs pt-4 text-gray-100">
